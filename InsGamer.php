    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav navbar-right main-nav">
                ...
                <li><a href="#esport">Info eSport</a></li>
                <li><a href="#general">Génerales</a></li>
				<li><a href="#bac">Baccalauréat</a></li>
    ...
    <section id="esport" class="section section-padded gray-bg">
        <div class="container">
            <div class="row text-center title">
                <h2>Informations eSport : League Of Legend</h2>
                <h4 class="light muted">Information sur votre parcours individuel League Of Legend</h4>
            </div>

            <div class="row">
                <div class="form-group">
                    <div class="col-sm-offset-2">
                        <h4><label for="inputRang" class="col-sm-4 control-label" > Rank:</label></h4>
                    </div>
                    <div class="col-sm-6" id="inputRang" style="margin-top: 1%">
                        <select name="rangSoloQ">
                ...
                <div class="form-group">
                    <div class="col-sm-offset-2">
                        <h4><label for="inputPosition" class="col-sm-4 control-label" >Main position in game:</label></h4>
                    </div>
                    <div class="col-sm-6" id="inputPosition" style="margin-top: 1%">
                        <select name="position">
                            <option>Top planer</option>
                ...
                <div class="col-lg-12" style="text-align: center">
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-1 col-sm-4" >
                            <input type="text" placeholder="Rang S6" size="50" name="gamerang1" required>
                        </div>

                    </div>
                    <div class="form-group"  >
                        <div class="col-sm-offset-1 col-sm-4" >
                            <input type="text" placeholder="Rang S5" size="50" name="gamerang2" required>
                        </div>

                    </div>
                    <div class="form-group" >
                        <div class="col-sm-offset-1 col-sm-4" >
                            <input type="text" placeholder="Rang S4" size="50" name="gamerang3" required>
                        </div>
                    </div>
    ...
    <section id="submit" class="section">
        <div class="row">
            <div class="col-sm-offset-4 col-sm-5">
                <button type="submit" class="btn btn-blue" name="formGamer">Submit</button>
            </div>
        </div>
        <div class="cut cut-bottom"></div>
    </section>
...
<section id="pricing" class="section">
    <div class="container">
        <div class="row title text-center">
            ...
            <h4 class="light white">Le tarifs pour intégrer l'école et les différents financements</h4>
        </div>
        <div class="row no-margin">
            <div class="col-md-7 no-padding col-md-offset-3 pricings text-center">
                <div class="pricing">
                    <div class="box-main active" data-img="img/pricing2.jpg">
                        <div style="margin-top: 25%"><h4 class="white">Classique</h4>
                        <h4 class="white regular light">6000€ <span class="small-font">/ an</span></h4></div>
                    </div>
                    <div class="box-second active">
                        <ul class="white-list text-left">
                            <li>Choix libre du diplôme</li>
                            <li>Accès illimité au locaux</li>
                            <li>Membre d'une équipe</li>
                            <li>Une expérience incroyable</li>
                            <li>Devenez acteur de se monde</li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <form action="" class="popup-form">
                ...
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu animated fadeIn" role="menu" aria-labelledby="dLabel">
                        <li class="animated lightSpeedIn"><a href="#">Grande Entrée</a></li>
                        <li class="animated lightSpeedIn"><a href="#">Classique</a></li>
                    </ul>
                </div>
                <div class="checkbox-holder text-left">
                    <div class="checkbox">
                        <input type="checkbox" value="None" id="squaredOne" name="check" />
                        <label for="squaredOne"><span>J'accepte les <strong>Termes</strong> &amp; <strong>Conditions</strong> de l'école</span></label>
                    </div>
                </div>
                <div class="checkbox-holder text-left">
                    <label for="squaredOne"><span>Nous vous contacterons dans les plus bref délais</span></label>
                </div>
                <button type="submit" class="btn btn-submit">Je m'inscrit</button>
            </form>
        </div>
    </div>
</div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-6 text-center-mobile">
                ...
                <h5 class="light regular light-white">Télécharger votre dossier d'admission !</h5>
                <a href="#" class="btn btn-blue ripple trial-button">Download</a>
            </div>
            <div class="col-sm-6 text-center-mobile">
                <h3 class="white">Ouverture de l'école<span class="open-blink"></span></h3>
                <div class="row opening-hours">
                    <div class="col-sm-6 text-center-mobile">
                        <h5 class="light-white light">Days</h5>
                        <h3 class="regular white">7/7</h3>
                    </div>
                    <div class="col-sm-6 text-center-mobile">
                        <h5 class="light-white light">Hours</h5>
                        <h3 class="regular white">24/24</h3>
                    </div>
                </div>
            </div>
        </div>
